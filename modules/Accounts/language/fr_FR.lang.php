...
$mod_strings = array(
    ...
    'ERR_DELETE_RECORD' => 'Vous devez spécifier un numéro d\'enregistrement avant de supprimer le compte.',
    'LBL_ACCOUNT_INFORMATION' => 'Aperçu', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    ...
    'LNK_ACCOUNT_LIST' => 'Voir les comptes',
    'LNK_NEW_ACCOUNT' => 'Créer un compte',
    'LNK_IMPORT_ACCOUNTS' => 'Importer',
    ...
    'MSG_SHOW_DUPLICATES' => 'Le compte que vous allez créer pourrait être un doublon d\'un compte existant. Les comptes existants avec des noms similaires sont listés ci-dessous.<br>Cliquez sur Sauvegarder pour valider la création d\'un nouveau compte, ou sur Annulation pour revenir au module sans créer de compte.',
