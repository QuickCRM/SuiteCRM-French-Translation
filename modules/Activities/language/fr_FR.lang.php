...
$mod_strings = array(
    ...
    'LBL_OVERVIEW' => 'Aperçu', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    ...
    'LNK_NEW_EMAIL' => 'Envoyer un email',
    ...
    'LBL_SCHEDULE_MEETING_BUTTON_TITLE' => 'Organiser une réunion',
    'LBL_SCHEDULE_MEETING_BUTTON_LABEL' => 'Organiser une réunion',
    'LBL_SCHEDULE_CALL_BUTTON_LABEL' => 'Créer un appel',
    'LBL_NEW_NOTE_BUTTON_TITLE' => 'Créer une note ou une pièce jointe',
    'LBL_NEW_NOTE_BUTTON_LABEL' => 'Créer une note ou une pièce jointe',
