...
$mod_strings = array(
    ...
    'LBL_BUSINESSCARD' => 'Convertir le lead',
    'LBL_CITY' => 'Ville :',
    'LBL_CONTACT_ID' => 'Contact (ID)',
    'LBL_CONTACT_INFORMATION' => 'Aperçu', //Can be translated in all caps. This string will be used by SuiteP template menu actions
    ...
    'LBL_CONVERTLEAD_TITLE' => 'Convertir le lead',
    'LBL_CONVERTLEAD' => 'Convertir le lead',
    'LBL_CONVERTLEAD_WARNING' => 'Attention : Le statut du lead que vous souhaitez convertir est "converti". Un contact et/ou un compte ont sans doute déja été créés à partir des informations de ce prospect. Si vous souhaitez tout de même convertir ce prospect, cliquez sur "sauvegarder". Sinon cliquez sur "annuler" pour retourner sur la page précédente.',
    ...
    'LBL_LEAD_SOURCE_DESCRIPTION' => 'Description origine :',
    'LBL_LEAD_SOURCE' => 'Origine du lead :',
    ...
    'LBL_SELECT_CHECKED_BUTTON_LABEL' => 'Sélectionner leads vérifiés',
    'LBL_SELECT_CHECKED_BUTTON_TITLE' => 'Sélectionner leads vérifiés',
    ...
    'LBL_PROSPECT_LIST' => 'Liste des leads',
    ...
    'LNK_IMPORT_LEADS' => 'Importer des leads',
//Convert lead tooltips
    ...
    'LBL_SELECTION_TIP' => 'Les modules liés avec le module contacts pourront être sélectionnés plutôt que créés durant le processus de conversion des leads.',
    ...
    'LBL_ACTIVITIES_MOVE_HELP' => "Sélectionner les enregistrements vers lesquels les activités du lead seront déplacées lors de la conversion. Les activités de type tâches, appels, réunions, notes et E-mails seront déplacées vers ces enregistrement sélectionnés.",
