...
$mod_strings = array(
    ...
    'LBL_LDAP_LEGACY_WARNING' => 'Avertissement LDAP',
    'LBL_LDAP_LEGACY_WARNING_MORE' => 'Cette configuration LDAP ne sera utilisée que pour l\'authentification de l\'API v4. Pour configurer la connexion à SuiteCRM avec LDAP, ajoutez les configurations nécessaires au fichier .env.local. Consultez la documentation de configuration LDAP pour plus d\'informations.',
    ...
    'LBL_SET_SUBPANEL_PAGINATION_TYPE' => 'Type de pagination des sous-panneaux',
