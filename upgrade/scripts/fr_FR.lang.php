...
$mod_strings = array(
    ...
    'LBL_DISABLED_DESCRIPTION' => 'Le programme d\'installation a déjà été exécuté une fois. Par mesure de sécurité, il a été désactivée pour une nouvelle exécution. Si vous êtes absolument sûr que vous voulez l\'exécuter à nouveau, veuillez modifier (ou ajouter) une variable appelée «installer_locked» avec la valeur «false» dans votre fichier config.php. La ligne devrait ressembler à ceci :',
    'LBL_DISABLED_DESCRIPTION_2' => 'Une fois cette modification appliquée, vous pouvez cliquer sur le bouton "Démarrer" pour commencer votre installation. <i> Ensuite, une fois l\'installation terminée, vous devrez modifier la valeur de \'installer_locked\' à \'true\'. </ i>',
    ...
    'LBL_REG_CONF_1' => 'Veuillez prendre un moment pour vous inscrire auprès de SuiteCRM. En nous informant un petit peu sur la manière dont votre entreprise envisage d\'utiliser SuiteCRM, nous pouvons nous assurer de toujours fournir le logiciel adapté à vos besoins.',
    'LBL_REG_CONF_2' => 'Votre nom et votre adresse électronique sont les seuls champs obligatoires pour l\'enregistrement. Tous les autres champs sont facultatifs, mais très utiles. Nous ne vendons, ni louons, ni partageons les informations recueillies ici à des tiers.',
    ...
    'ERR_CHECKSYS_SAFE_MODE' => 'Le mode sans échec est activé (veuillez le désactiver dans php.ini)',
    'ERR_DB_ADMIN' => 'Nom d\'utilisateur de la base de données et/ou mot de passe invalide (erreur ',
    'ERR_DB_EXISTS_NOT' => 'La base de données spécifiée n\'existe pas.',
    'ERR_DB_EXISTS_WITH_CONFIG' => 'La base de données existe déjà avec les données de configuration. Pour exécuter une installation avec la base de données choisie, lancez à nouveau l\'installation et choisissez : "Supprimer les tables existantes et les recréer ?" dans l\'assistant de mise à niveau depuis la console d\'administration. Veuillez consulter la documentation de mise à niveau <a href="https://docs.suitecrm.com/admin/installation-guide/upgrading/" target="_new">ici</a>.',
    'ERR_DB_EXISTS' => 'Le nom de la base de données existe déjà--impossible d\'en créer une autre portant le même nom.',
    ...
    'ERR_DB_MYSQL_VERSION2' => ' n\'est pas pris en charge. Les versions de MySQL prises en charge commencent à partir de 4.1.x.',
    ...
    'ERR_LOG_DIRECTORY_REQUIRED' => 'Le répertoire de journaux est requis si vous souhaité préciser le vôtre.',
    ...
    'ERR_PERFORM_NO_TCPIP' => '<b>Nous n\'avons pas pu détecter de connexion Internet.</b> Une fois la connexion établie, rendez-vous sur <a href=\\"http://www.suitecrm.com\\">http://www.suitecrm.com</a> pour vous enregistrer auprès de SuiteCRM. En nous informant sur la manière dont votre entreprise envisage d\'utiliser SuiteCRM, nous pouvons nous assurer que nous fournissons toujours le bon logiciel pour vos besoins.',
    'ERR_SESSION_DIRECTORY_NOT_EXISTS' => 'Le répertoire de session n\'est pas un dossier valide.',
    'ERR_SESSION_DIRECTORY' => 'Le répertoire de session est inaccessible en écriture.',
    'ERR_SESSION_PATH' => 'Un chemin de session est requis si vous souhaitez préciser le vôtre.',
    ...
    'ERR_SITE_GUID' => 'Un identifiant d\'application est requis si vous souhaitez définir le vôtre.',
    ...
    'LBL_CHECKSYS_CURL' => 'bibliothèque Curl',
    ...
    'LBL_CHECKSYS_MODULE' => 'Sous-répertoire Modules et ses fichiers accessible en écriture',
    ...
    'LBL_CHECKSYS_SESSION' => 'Chemin d\'enregistrement de session accessible en écriture (',
    'LBL_CHECKSYS_STATUS' => 'Statut',
    'LBL_CHECKSYS_TITLE' => 'Acceptation de la vérification du système',
    'LBL_CHECKSYS_XML' => 'Parseur XML',
    'LBL_CLOSE' => 'Fermer',
    'LBL_CONFIRM_BE_CREATED' => 'est créé',
    'LBL_CONFIRM_DB_TYPE' => 'Type de base de données',
    'LBL_CONFIRM_DIRECTIONS' => 'Veuillez confirmer les réglages ci-dessous. Cliquez sur "Précédent" pour modifier les valeurs que vous souhaiteriez. Sinon, cliquez sur "Suivant" pour commencer l\'installation.',
    ...
    'LBL_DBCONF_CREATE_USER' => 'Créer un utilisateur',
    ...
    'LBL_PERFORM_DEMO_DATA' => 'Remplir la base de données avec des données de démonstration (cela peut prendre quelques instants)...',
    ...
    'LBL_PERFORM_TABLES' => 'Création des tables de données, des tables de vérification et des liens de métadonnées de SuiteCRM...',
    ...
    'LBL_SITECFG_APP_ID' => 'Identité d\'Application',
    ...
    'LBL_WELCOME_2' => 'Pour une aide à l\'installation, veuillez visiter les <a href="https://suitecrm.com/suitecrm/forum/suite-forum" target="_blank">forums de support SuiteCRM</a>.',
